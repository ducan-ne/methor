...
function Methor(opts) {
  ...
  (0, _util.setPropertyOf)(methor, this);
...
Methor.prototype.handlerResponse = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, result) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if ((0, _util.isFunction)(this.$options.catchHandler)) {
              this.$options.catchHandler(_context.t0, req, res);
            } else {
  ...
  function handlerResponse(_x, _x2, _x3) {
