        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if ((0, _util.isFunction)(_this.$options.catchHandler)) {
                _this.$options.catchHandler(_context.t0, req, res);
              } else {
...
Methor.prototype.use = function (plugin, opts) {
  ...
  this.$options.plugins.push((0, _util.isFunction)(plugin) ? plugin(opts) : plugin);
  this.installPlugin();
  return this;
};
