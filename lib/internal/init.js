...
function Init() {
  ...
  var parseBodyJson = _bodyParser2.default.json(opts.parseBodyJson);
  var parseBodyFormData = _bodyParser2.default.urlencoded((0, _util.isObject)(opts.parseBody) ? opts.parseBody : { extended: false });
  ...
  if ((0, _util.isNumber)(opts.port) || (0, _util.isNull)(opts.port)) {
    (0, _util.defer)(function () {
      _this.listen(opts.port);
    });
  }
}