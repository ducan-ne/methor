...
function Handler(req, res, callback) {
  ...
  // restserver layer
  var rPath = 'string' == typeof this.$options.pathname ? this.$options.pathname : '/restserver';

  var rRoute = new _route2.default(rPath);

  var rLayer = new _layer2.default(rPath, {
  ...
  var stack = [rLayer].concat(_toConsumableArray(this.stack));
